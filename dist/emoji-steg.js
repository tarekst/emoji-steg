...
export class EmojiSteg {
     ...
     */
    getRandomEmojiFromCategory(category) {
     ...
     * @private
     */
    _generateKey(password, salt = 'EmojiSteg') {
     ...
     * @private
     */
    _decryptData(encrypted, password) {
        const key = this._generateKey(password);
     ...
     * @private
     */
    _binaryToInvisibleChars(binaryString) {
        let result = '';
     ...
     * @private
     */
    _invisibleCharsToBinary(invisibleSequence) {
        let binaryString = '';
     ...
     */
    encrypt(text, password, emoji = this.defaultEmoji) {
        // Encrypt text
 ...
 * @returns The emoji with hidden text
 */
export function encryptInEmoji(text, password, emoji) {
 ...
 * @returns The decrypted text
 */
export function decryptFromEmoji(emojiMessage, password) {
    const emojiSteg = new EmojiSteg();
